...
?>
    ...
    <script language=Javascript>
        ...
        window.onLoad = dochange('project_group_r', -1);
...
<div class="container">
   ...
   <legend> <a href="./" class="btn btn-default" > กลับ</a> แบบฟอร์มเพิ่มโครงการแผนบูรณาการพัฒนาพื้นที่ระดับภาค</legend>
<div class="stepwizard">
 ...
 <form action="assets/add_pro_r.php" method="post" >
        ...
        <div class="col-xs-12">
            <div class="col-md-12"><hr>
                      ...
                      <div class="form-group">
                        <label for="control-label">เลือกยุทธศาสตร์ชาติ 20 ปี</label>
                          <span id="strategic20">
    ...
    <div class="row setup-content" id="step-5">
        <div class="col-xs-12">
            <div class="col-md-12"><hr>
                ...
                <input type="hidden" class="form-control" id="" name="project_type" value="r">
