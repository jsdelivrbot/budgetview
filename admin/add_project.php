    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                  ...
                  <form action="assets/add_pro.php" method="post">
                    <fieldset>
                      <legend> <a href="./" class="btn btn-default" > กลับ</a> เพิ่มข้อมูลโครงการใหม่</legend>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" aria-describedby="emailHelp" name="prj_name" placeholder="" required>
                      </div>
                      ...
                      <button type="submit" class="btn btn-primary"  onclick="return confirm('ยืนยันการบันทึก?')">ถัดไป</button>
                    </fieldset>
                  </form>
