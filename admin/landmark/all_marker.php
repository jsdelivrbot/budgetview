...
var polygonLayer = new L.GeoJSON.AJAX("http://www2.cgistln.nu.ac.th/budgetview/admin/landmark/all_geojson.php?type=polygon&region=<?php echo $region; ?>&prov_name=<?php echo $prov_name; ?>&_name=<?php echo $amp_name; ?> &tam_name=<?php echo $tam_name; ?>&project_group=<?php echo $project_group; ?>&type_project=<?php echo $type_project; ?>&sub_project_group=<?php echo $sub_project_group; ?>&strategic20=<?php echo $strategic20; ?>&substrategic20=<?php echo $substrategic20; ?>&economic_plan=<?php echo $economic_plan; ?>&economic_target=<?php echo $economic_target; ?>&economic_measure=<?php echo $economic_measure; ?>&integration_29=<?php echo $integration_29; ?>&integration_target=<?php echo $integration_target; ?>",{ 
    onEachFeature: onEachFeature
}).addTo(map);

var lineLayer = new L.GeoJSON.AJAX("http://www2.cgistln.nu.ac.th/budgetview/admin/landmark/all_geojson.php?type=polyline&region=<?php echo $region; ?>&prov_name=<?php echo $prov_name; ?>&_name=<?php echo $amp_name; ?> &tam_name=<?php echo $tam_name; ?>&project_group=<?php echo $project_group; ?>&type_project=<?php echo $type_project; ?>&sub_project_group=<?php echo $sub_project_group; ?>&strategic20=<?php echo $strategic20; ?>&substrategic20=<?php echo $substrategic20; ?>&economic_plan=<?php echo $economic_plan; ?>&economic_target=<?php echo $economic_target; ?>&economic_measure=<?php echo $economic_measure; ?>&integration_29=<?php echo $integration_29; ?>&integration_target=<?php echo $integration_target; ?>",{ 
    onEachFeature: onEachFeature
}).addTo(map);

var markerLayer = new L.GeoJSON.AJAX("http://www2.cgistln.nu.ac.th/budgetview/admin/landmark/all_geojson.php?type=marker&region=<?php echo $region; ?>&prov_name=<?php echo $prov_name; ?>&_name=<?php echo $amp_name; ?> &tam_name=<?php echo $tam_name; ?>&project_group=<?php echo $project_group; ?>&type_project=<?php echo $type_project; ?>&sub_project_group=<?php echo $sub_project_group; ?>&strategic20=<?php echo $strategic20; ?>&substrategic20=<?php echo $substrategic20; ?>&economic_plan=<?php echo $economic_plan; ?>&economic_target=<?php echo $economic_target; ?>&economic_measure=<?php echo $economic_measure; ?>&integration_29=<?php echo $integration_29; ?>&integration_target=<?php echo $integration_target; ?>",{ 
    onEachFeature: onEachFeature
}).addTo(map);
