...
var polygonLayer = new L.GeoJSON.AJAX("http://www2.cgistln.nu.ac.th/budgetview/landmark/geojson.php?type=polygon&project=<?php echo $idproject; ?>",{ 
    onEachFeature: onEachFeature
}).addTo(map);

var lineLayer = new L.GeoJSON.AJAX("http://www2.cgistln.nu.ac.th/budgetview/landmark/geojson.php?type=polyline&project=<?php echo $idproject; ?>",{ 
    onEachFeature: onEachFeature
}).addTo(map);

var markerLayer = new L.GeoJSON.AJAX("http://www2.cgistln.nu.ac.th/budgetview/landmark/geojson.php?type=marker&project=<?php echo $idproject; ?>",{ 
    onEachFeature: onEachFeature
}).addTo(map);
...
function onEachFeature(feature, layer) {   
        var popupContent = '<form role="form"  id="form" class="form" enctype="multipart/form-data">'+
            ...
            'กรอกรายละเอียดเพิ่มเติม <br>'+
            '<input type="text" id="desc_t" value = "'+feature.properties.desc_t+'"><br>'+
