...
<body>
    ...
    <div class="content-wrapper">
        ...
        <input type="hidden" class="form-control" id="" name="idproject" value="<?php echo $idproject; ?>">
                      <button type="submit" class="btn btn-primary" onclick="return confirm('ยืนยันการบันทึก?')" >บันทึกพื้นที่</button>
                    </fieldset>
                  </form>
<br>
 ...
 <?php 
         ...
         <?php } ?>
                  ...
                  <a href="project_detail.php?prj=<?php echo $idproject; ?>"  class="btn btn-success">เสร็จสิ้นการบันทึก</a>
                  <button type="submit" class="btn btn-primary">เพิ่มตำแหน่งแบบเจาะจงพื้นที่</button>
