...
?>
    ...
    <script language=Javascript>
      ...
      function dochange(src, val) {
        ...
        req.open("GET", "location_view.php?data=" + src + "&val=" + val);
        req.send(null);
      }
    ...
    <style type="text/css" media="screen">
      #loading {
        background: transparent url(https://d13yacurqjgara.cloudfront.net/users/82092/screenshots/1073359/spinner.gif) no-repeat top center;
      }
    </style>
</head>
...
<body>
      ...
      <div class="row">
        <div class="col-md-3">
          <form class="form-horizontal" target="map_php" action="map_budget1.php" method="get">
            <fieldset>
              <h4 class="page-head-line">เลือกพื้นที่</h4>
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="all_group">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642" >
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="project_group">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642" >
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="sub_project_group">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642" >
                                          <option value=''>- เลือกทั้งหมด -</option>
                                        </select>
                               </span> </div>
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="strategic20">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642" >
                                          <option value=''>- เลือกทั้งหมด -</option>
                                        </select>
                                      </span> </div>
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="substrategic20">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642"  >
                                          <option value=''>- เลือกทั้งหมด -</option>
                                        </select>
                                      </span> </div>
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="economic_plan">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642" >
                                          <option value=''>- เลือกทั้งหมด -</option>
                                        </select>
                                      </span> </div>
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="economic_target">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642" >
                                          <option value=''>- เลือกทั้งหมด -</option>
                                        </select>
                                      </span> </div>
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="integration_29">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642" >
                                          <option value=''>- เลือกทั้งหมด -</option>
                                        </select>
                                      </span> </div>
              ...
              <div class="form-group">
                <div class="col-lg-12"> <span id="integration_target">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642" >
                                          <option value=''>- เลือกทั้งหมด -</option>
                                        </select>
                                      </span> </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  <div class="col-lg-10 ">
                    <a data-toggle="collapse" class="btn btn-danger btn-block" data-target="#demo">เปรียบเทียบกับพื้นที่อื่น</a> </div>
                </div>
              </div>
            </fieldset>
            <div id="demo" class="collapse">
                            ...
                            <fieldset>
                                <h4 class="page-head-line">เลือกพื้นที่เปรียบเทียบ</h4>
                                <div class="form-group">
                                    <label for="select" class="col-lg-2 control-label">ภูมิภาค</label>
                                    <div class="col-lg-10">
                                        <span id="region2">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642">
                                           <option value='%'>- เลือกทุกภูมิภาค -</option>
                                ...
                                <div class="form-group">
                                    <label for="select" class="col-lg-2 control-label">จังหวัด</label>
                                    <div class="col-lg-10">
                                        <span id="prov_name2">
                                        <select class="form-control" id="select" data-cip-id="cIPJQ342845642">
                                           <option value='%'>- เลือกทุกจังหวัด -</option>
                                ...
                                <div class="form-group">
                                    <label for="select" class="col-lg-2 control-label">อำเภอ</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <label for="select" class="col-lg-2 control-label">ตำบล</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="col-lg-10 col-lg-offset-2">
                                            <button type="submit" formaction="map_budget2.php" class="btn btn-danger" name="no_sql" value="1">ค้นหาข้อมูลเปรียบเทียบ</button>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-md-9" id="loading"> <iframe src="map_budget1.php" name="map_php" style="width: 100%; height: 1850px " frameborder="0" scrolling="yes"></iframe> </div>
      </div>
    </div>
    <!-- MENU SECTION END-->
  </div>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-12"> <img src="https://upload.wikimedia.org/wikipedia/th/thumb/1/15/NU_Logo.png/200px-NU_Logo.png" alt="" width="3%"> <img src="http://www.cgistln.nu.ac.th/gistweb_2013/images/logo_gistv1.png" alt="" width="10%"> พัฒนาโดย สถานภูมิภาคเทคโนโลยีอวกาศและภูมิสารสนเทศ ภาคเหนือตอนล่าง มหาวิทยาลัยนเรศวร </div>
      </div>
    </div>
  </footer>
  <!-- FOOTER SECTION END-->
