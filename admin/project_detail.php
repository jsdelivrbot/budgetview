...
<?php 
     $result3 = pg_query("select * from  budget_view2 a
                         ...
                         full join user_id c on a.user_id = c.user_id
...
<a href="add_area.php?idproject=<?php echo $arr3[prj_id]; ?>&user=<?php echo $id; ?>"  class="btn btn-info">แก้ไขข้อมูลพื้นที่</a>
                            ...
                            <table class="table">
                                <tr>
                                    <td>ผู้เขียนโครงการ : </td>
                                    <td><?php echo $arr3[name_user],' ',$arr3[last_user]; ?></td>
                                </tr>
                                <tr>
                                    <td>เบอร์โทรศัพท์ : </td>
                                    <td><?php echo $arr3[phone_user]; ?></td>
                                </tr>
                                <tr>
                                    <td>E-Mail : </td>
                                ...
                                <tr>
                                    <td>หน่วยงาน : </td>
                                    <td><?php echo $arr3[office_user]; ?></td>
                                </tr>
                                <tr>
                                    <td>อำเภอ : </td>
                                    <td><?php echo $arr3[amp_user]; ?></td>
                                </tr>
                                <tr>
                                    <td>จังหวัด : </td>
                             ...
                             <a href="detail_user.php?user=<?php echo $arr3[user_id]; ?>" class="btn"><i class="fa fa-search"> </i> ดูโครงการทั้งหมดของ<?php echo $arr3[name_user],' ',$arr3[last_user]; ?> </a>
                      </div>
